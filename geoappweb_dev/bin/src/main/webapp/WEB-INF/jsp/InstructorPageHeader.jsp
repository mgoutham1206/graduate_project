  ...
  <body class="hold-transition skin-green sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <!-- Logo -->
        <a href="index2.html" class="logo" id="geoapplogo" style="height: 140px">
          ...
          <center>
			<h3 style="color:white; font-size: xx-large;">Geographical Rock App.</h3><span style="color:white; font-style: italic;">->Learning the life of rock.</span>
              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                   <li class="dropdown user user-menu">
                   <a href="/GeoApp/instructor/openSection/listAssignments?secId=${secId}&instructorId=${instructorId}" onclick="selectMenu(this)"><i class="glyphicon glyphicon-list-alt">
