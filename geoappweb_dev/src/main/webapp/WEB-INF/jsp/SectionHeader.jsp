          ...
          <center>
			<h3 style="color:white; font-size: xx-large;">Geographical Rock App.</h3><span style="color:white; font-style: italic;">->Learning the life of rock.</span>
              ...
              <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                  <%--  <li class="dropdown user user-menu">
                   <a href="/GeoApp/view/instructor/openSection/listAssignments?secId=${secId}" onclick="selectMenu(this)"><i class="glyphicon glyphicon-list-alt">
             ...
             <%--   <li class="dropdown user user-menu">
               ...
               <!-- <li class="dropdown user user-menu" id="Inst_Eval">
                                <a href="/instructor/getSections" onclick="selectMenu(this)"><i class="glyphicon glyphicon-folder-close"></i>
                                <span class="hidden-xs" style="font-size: larger;">Evaluation</span>
                                </a>                
              </li>
               -->
            ...
            <!-- <li class="dropdown user user-menu" id="link_geomap">
                                <a href="/client/geomap/instructor" onclick="selectMenu(this)"><i class="glyphicon glyphicon-folder-close"></i>
                                <span class="hidden-xs" style="font-size: larger;">Geo-Map</span>
                                </a>                
              </li>
              
                <li class="dropdown user user-menu" id="link_geninfo">
...
$(document).ready(function() {
	$("#link_geninfo").click(function(e){
		console.log("clicked");
		window.location.href="/GeoApp/client/general-info/types";
	});
