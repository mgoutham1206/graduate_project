...
%>
    ...
    <form:form action="viewprogress" modelAttribute="phaseThreeForm" method="get">
    <div class="rname">
        <p>Rock Type:
		<c:out value="${phaseThreeForm.rockType}"></c:out>
        </p>
        </br>
        <p>Rock Name:
        <c:out value="${phaseThreeForm.rockName}"></c:out>
         </p>   
         <br/>
         <c:out value="${comment}"/>
