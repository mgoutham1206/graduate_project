...
//
//@Transactional
//public class NonMetallicTest {
//
//	@Autowired
//	private NonMetallicRepository mineralRepo;
//	
//	@Before
//	public void setUp(){
...
//		List<nonmetallic> list = mineralRepo.findAll();
//		
...
//		nonmetallic metal = mineralRepo.findOne(id);
...
//		Iterator<nonmetallic> iter = mineralRepo.findAll().iterator();
//		while (iter.hasNext()) {
...
//			Iterator<nonmetallic> iterator = mineralRepo.findByStreakcolor(s).iterator();
...
//		for(String s : color){
//			//System.out.println(s);
//			Iterator<nonmetallic> iterator = mineralRepo.findByColor(s).iterator();
//			while (iterator.hasNext()) {
//				metalStreak.add(iterator.next().getMineral());
//				}			
//		}
