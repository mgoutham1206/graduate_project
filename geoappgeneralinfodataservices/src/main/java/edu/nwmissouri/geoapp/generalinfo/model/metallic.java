...
public class metallic {
	...
	public metallic(String _id, double hardnessmin, double hardnessmax, double sgmin, double sgmax, List<String> streakcolor,
			List<String> color, String cleavage, int sets, int angle, String mineral) {
		//super();
		this._id = _id;
	...
	public String toString() {
		return "metallic [_id=" + _id + ", hardnessmin=" + hardnessmin + ", hardnessmax=" + hardnessmax + ", sgmin="
